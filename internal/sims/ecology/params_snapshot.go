	...
	groups := []core.ParameterGroup{
		...
		},
		{
			...
			Params: []core.Parameter{
				...
				intParam("lava_slope_scale_min", "Lava slope scale min", params.LavaSlopeScaleMin),
				intParam("lava_slope_scale_max", "Lava slope scale max", params.LavaSlopeScaleMax),
				floatParam("lava_flow_threshold", "Lava flow threshold", params.LavaFlowThreshold),
				floatParam("lava_slope_weight", "Lava slope weight", params.LavaSlopeWeight),
				floatParam("lava_align_weight", "Lava alignment weight", params.LavaAlignWeight),
				floatParam("lava_channel_weight", "Lava channel weight", params.LavaChannelWeight),
				floatParam("lava_rain_weight", "Lava rain weight", params.LavaRainWeight),
				floatParam("lava_wall_weight", "Lava wall weight", params.LavaWallWeight),
